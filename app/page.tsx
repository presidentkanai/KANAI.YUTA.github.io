...
export default function Home() {
  ...
  // 1. イントロの待ち時間を調整 (アニメーション速度に合わせて5.5秒に変更)
  useEffect(() => {
  ...
  const cards = [
    ...
    },
    {
      ...
      link: "/othello" // Main Projectのリンク先
    },
    {
      title: "Vision",
      gridClass: "md:col-span-2",
      ...
      link: "/vision" // 2. Visionページへのリンクを修正
    }
  ];
